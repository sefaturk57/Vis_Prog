...
# 3-) Sonra vs studioyu açıp open local folder dersin.
...
# 5-) Ardından da f7 ya da ekranda gördüğün  forma basarak code kısmına gelirsin. (Double click atarsan atama yapmış olursun, yapma.)
